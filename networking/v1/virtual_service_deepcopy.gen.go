...
// DeepCopyInto supports using HTTPRoute_HeaderToDynamicSubsetKey within kubernetes types, where deepcopy-gen is used.
func (in *HTTPRoute_HeaderToDynamicSubsetKey) DeepCopyInto(out *HTTPRoute_HeaderToDynamicSubsetKey) {
	p := proto.Clone(in).(*HTTPRoute_HeaderToDynamicSubsetKey)
	*out = *p
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRoute_HeaderToDynamicSubsetKey. Required by controller-gen.
func (in *HTTPRoute_HeaderToDynamicSubsetKey) DeepCopy() *HTTPRoute_HeaderToDynamicSubsetKey {
	if in == nil {
		return nil
	}
	out := new(HTTPRoute_HeaderToDynamicSubsetKey)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInterface is an autogenerated deepcopy function, copying the receiver, creating a new HTTPRoute_HeaderToDynamicSubsetKey. Required by controller-gen.
func (in *HTTPRoute_HeaderToDynamicSubsetKey) DeepCopyInterface() interface{} {
	return in.DeepCopy()
}
